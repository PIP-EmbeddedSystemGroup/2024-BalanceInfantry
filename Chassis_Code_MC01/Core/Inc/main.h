...
/* Private defines -----------------------------------------------------------*/
#define Interactive_Power_En_Pin GPIO_PIN_13
#define Interactive_Power_En_GPIO_Port GPIOC
#define RS485_DIR1_Pin GPIO_PIN_15
#define RS485_DIR1_GPIO_Port GPIOC
#define ROBOT_STATE_LED_Pin GPIO_PIN_0
#define ROBOT_STATE_LED_GPIO_Port GPIOC
...
#define Gimbal_Power_En_Pin GPIO_PIN_4
#define Gimbal_Power_En_GPIO_Port GPIOC
...
#define RS485_GND_Pin GPIO_PIN_8
#define RS485_GND_GPIO_Port GPIOC
#define RS485_VCC_Pin GPIO_PIN_9
