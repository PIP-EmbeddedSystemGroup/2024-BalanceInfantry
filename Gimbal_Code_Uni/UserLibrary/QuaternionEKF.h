 ...
 ******************************************************************************
 */
#ifndef _QUATERNION_EKF_H
#define _QUATERNION_EKF_H
#include "KalmanFilterInertial.h"
...
{
    uint8_t Initialized;
    KalmanFilter_inertial_t IMU_QuaternionEKF;
...
extern QEKF_Inertial_t QEKF_INERTIAL;
