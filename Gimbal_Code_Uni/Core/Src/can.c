...
void HAL_CAN_RxFifo0MsgPendingCallback(CAN_HandleTypeDef* hcan)
{
  ...
  if (hcan->Instance == CAN1)
  {
    ...
    case 0x20B:
      ...
      break;
    default:
      DM4310_TryUpdate(RxMessage.StdId, Data);
      break;
    }
  }
}
...
void HAL_CAN_RxFifo1MsgPendingCallback(CAN_HandleTypeDef* hcan)
{
  ...
  if (hcan->Instance == CAN2)
  {
    switch (RxMessage.StdId)
    {
      ...
      //   ChassisBoard_ReceiveError(&RxMessage, Data);
      //   break;
      // case BOARD_COMM_CHASSIS_ODOMETER_SPEED_CANID:
      //   ChassisBoard_ReceiveSpeed(&RxMessage, Data);
      //   break;
    case 0x208:
      DjiMotor_Update(&Gimbal.Yaw.MotorWithoutInit, Data);
      break;
    default:
      break;
    }
